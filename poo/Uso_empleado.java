...
public class Uso_empleado {
	...
	public static void main(String[] args) {
		...
		jefa_Finanzas.estableceIncentivo(1000);
		
		Jefatura jefe_Informatica=(Jefatura)misEmpleados[4];
		
		jefe_Informatica.estableceIncentivo(1000);
		...
		System.out.println(jefa_Finanzas.tomar_decisiones("Despedir a todos los empleados"));
		
		
		
		System.out.println("El bonus de "+ jefa_Finanzas.dameNombre()+" es: "+jefa_Finanzas.establece_bonus(500));
...
class Jefatura extends empleado implements Jefes {
	...
	//metodo para implementar interfaz
